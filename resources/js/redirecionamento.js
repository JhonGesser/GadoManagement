...
function redirecionaCadastroProdutos(){
    window.location.href = "./cadastroProdutos.html";
}

function redirecionaDespezasAnimal(){
    window.location.href = "./cadastroDespeza.html";
}
...
function redirecionaAtividadesRealizadaAnimal(){
    window.location.href = "./atividadesRealizadaAnimal.html";
}
